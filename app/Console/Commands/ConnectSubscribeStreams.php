...
class ConnectSubscribeStreams extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'aws:connect-subscribe-streams {company?} {account_number?} {region?} {instance?}';
     ...
     * @var string
     */
    protected $description = 'Subscribes to all Instance Streams and Prints to the Console';
