...
class ListInstance extends Command
{
    ...
    {   
        ...
        */
        ...
        if($this->company_id){
            $as = Account::where('company_id', $this->company_id);
            foreach($as as $a){
        ...
        foreach($accounts as $account){
            ...
            foreach($regions as $region){
                ...
                foreach($result['InstanceSummaryList'] as $instance){
                    ...
                    $data = Instance::updateOrCreate(['name' => $name, 'instance_id' => $id, 'account_id' => $account], ['region' => $region, 'flows' => $custom_flows_json, 'storage' => $storage_json, 'json' => $json]);
